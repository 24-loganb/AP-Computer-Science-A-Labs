...
public class MovieTheatreSale {
  //instance variables
    ...
    public MovieTheatreSale()
    {
         ...
         */
        time = timeHours*100 + timeMinutes;
        ...
        */
        ...
        you will need to ask for the number of each type of ticket.*/
            ...
            if(adultTickets + childTickets + seniorTickets != totalTickets) {
    ...
    {
        return adultTickets*ADULT_TICKET_PRICE + childTickets*CHILD_TICKET_PRICE + seniorTickets*SENIOR_TICKET_PRICE + matineeTickets*MATINEE_TICKET_PRICE;
    }
