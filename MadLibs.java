...
public class MadLibs {
    ...
    public MadLibs()
    {
        ...
        System.out.println("Please enter a plural body part: ");
        bodyPartPlural = in.nextLine();
        System.out.println("Please enter a color: ");
        color = in.nextLine();
        System.out.println("Please enter a plural animal: ");
        animalPlural = in.nextLine();
        System.out.println("Please enter a beverage: ");
    ...
    public String createStory()
    {
        ...
        while(story.indexOf("adjective") >= 0)
        {
        ...
        while(story.indexOf("pluralBodyPart") >= 0)
        {
